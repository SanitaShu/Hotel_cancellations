...
# VISUALISATIONS
# ------------------------------------------------------------
# VISUALISATIONS (clean, improved, with correct ordering)
# ------------------------------------------------------------
st.subheader("Visualisations")

# --- Helper: convert numeric months to names ---
def month_name_and_number(month_col):
    month_num = pd.to_numeric(month_col, errors="coerce").astype("Int64")
    month_name = month_num.apply(lambda x: calendar.month_name[int(x)] if pd.notnull(x) else None)
...
if "arrival_date_month" in df_f.columns:
    ...
    df_f = df_f.dropna(subset=["month_num"])  # Remove invalid months


# ============================================================
# 1) ADR + Cancellation Rate per Month (Bar + Line Combo)
# ============================================================
...
# ============================================================
# 2) Donut Chart — Cancellation Share by Hotel Type
# ============================================================
...
# ============================================================
# 3) Line Chart — Cancellation Rate by Lead Time Bucket
# ============================================================
